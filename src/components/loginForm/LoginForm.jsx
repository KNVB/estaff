...
export default function LoginForm() {
    ...
    document.title = "EMSTF Staff Page";
    return (
        <div className='main'>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input autoComplete="username" name="adUserName" onChange={updateTextField} required type="text" value={adUserName} />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input autoComplete="current-password" name="adPassword" onChange={updateTextField} required type="password" value={adPassword} />
